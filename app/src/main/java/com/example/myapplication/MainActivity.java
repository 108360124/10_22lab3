...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name = findViewById(R.id.textView5);
        tv_winner = findViewById(R.id.textView2);
        tv_mmora = findViewById(R.id.textView4);
        tv_cmora = findViewById(R.id.textView3);
        btn_scissor = findViewById(R.id.btn_scissor);
        btn_stone = findViewById(R.id.btn_stone);
        btn_paper = findViewById(R.id.btn_paper);
        btn_mora = findViewById(R.id.button3);
        ...
        btn_mora.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if(ed_name.length() < 1)   tv_text.setText("請輸入玩家姓名");
                    ...
                    else if(btn_stone.isChecked()) tv_mmora.setText("我方出拳\n石頭");
